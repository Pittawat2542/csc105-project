...
@section('content')
    @if($puppy)
        <section id="puppy" class="container mt-5 mb-5">
            <h5 class="scrolling-wrapper"><span class="opacity50">{{$puppy->category->breed}}</span> <span
                        class="text-primary text-uppercase font-weight-bold">{{$puppy->title}}</span></h5>
                        ...
                        <div class="container-fluid">
                            <div id="row-line-fb" class="row">
                                <div class="col-md-6 text-center" id="line">
                                    <a href="https://line.me/th/{{$puppy->line}}" class="btn btn-primary social-button no-border-radius" target="blank">
                                        <h4><img class="mr-1" src="/images/line.png" alt=""> LINE
                                        </h4>
                                    </a>
                                </div>
                                <div class="col-md-6 text-center" id="fb">
                                    <a href="https://www.facebook.com/{{$puppy->facebook}}" class="btn btn-primary social-button no-border-radius"
                                       target="blank">
                            ...
                            <div id="row-mail-call" class="row mt-3">
                                <div class="col-md-6 text-center" id="mail">
                                    <a href="mailto:{{$puppy->user->email}}" class="btn btn-primary social-button no-border-radius"
                                       target="blank">
                                ...
                                <div class="col-md-6 text-center" id="call">
                                    <a href="tel:{{$puppy->phone}}" class="btn btn-primary social-button no-border-radius" target="blank">
            ...
            <div id="description" class="row">
                ...
                <div class="mt-3">
                    ...
                    @if($puppy->category->pdf!=null)
                        <p>About breed</p>
                        <embed src="{{$puppy->category->pdf}}" width="800" height="800" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">
                    @endif
                </div>
            </div>
        </section>
