...
@section('content')
    @if($offers)
        <section id="announcement">
            <div class="container">
                <h1 class="text-uppercase mb-3">Edit Announcement</h1>
                {!! Form::model($offers, ['method'=>'PATCH', 'action'=>['OffersController@update',
                                        $offers->id], 'class'=>'ml-0 ml-md-5']) !!}
                ...
                {!! Form::submit('Save changes', ['class'=>'btn btn-primary mt-5']) !!}
                {!! Form::close() !!}
            </div>
            <br>
        </section>
