                     ...
                     <div class="picture-uploader">
                        ...
                        <div class="upload">
                           ...
                           <div class="commit-button sticky-left">
                              ...
                              <input id="profile_image" name="profile_image" type="file" accept="image/png, image/jpg, image/jpeg"></input>
                           </div>
                        </div>
                     </div>
            ...
            <div class="section">
               ...
               <form action="" method="post" class="indent-box">
                     ...
                     <div class="commit-button" style="margin-top: 1rem;">
                        <label for="id_card_image" class="inner-blue box-shadow" style="margin-top: 1rem;">SELECT FILE</label>
                        <input id="id_card_image" name="id_card_image" type="file" accept="image/png, image/jpg, image/jpeg"></input>
                     </div><br/>
