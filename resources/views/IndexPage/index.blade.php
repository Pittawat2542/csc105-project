...
<body>
    <div class="container">
        ...
        <div class="jumbotron bg-white no-rounding mt-5">
            ...
            <p class="lead text-center mt-5 ml-auto mr-auto">Lorem ipsum dolor sit amet, an laoreet commune
                signiferumque est. Ut dui
                elit, tempus facilisis tortor et, lobortis lacinia dui.</p>
            <div class="d-flex justify-content-center mt-3">
                <div class="p-2">
                    <h5 class="d-inline"><a class="font-weight-bold" href="#">Learn More ></a></h5>
                </div>
                <div class="p-2 ml-5">
                    <h5 class="d-inline"><a class="font-weight-bold" href="#">Buy ></a></h5>
                </div>
            </div>
        </div>
