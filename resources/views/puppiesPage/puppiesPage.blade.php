...
<head>
    ...
    <link rel="stylesheet" href="puppiesPage.css">
                ...
                <div class="product-slider">
                    <div id="carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="item active"> <img src="../../../design/assets/225-4.jpeg"> </div>
                            <div class="item"> <img src="../../../design/assets/225-4.jpeg"> </div>
                            <div class="item"> <img src="../../../design/assets/225-4.jpeg"> </div>
                            <div class="item"> <img src="../../../design/assets/225-4.jpeg"> </div>
                            <div class="item"> <img src="../../../design/assets/225-4.jpeg"> </div>
                            <div class="item"> <img src="../../../design/assets/225-4.jpeg"> </div>
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div data-target="#carousel" data-slide-to="0" class="thumb"><img
                                            src="../../../design/assets/225-4.jpeg"></div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="mt-3">
                        <h4 class="float-right" id="seller-name"><img id="user-img" class="circle-border mr-5"
                                src="../../../design/assets/31.jpg" alt="">Abcd Gef</h4>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-5 text-center" id="line">
                            <a href="https://line.me/th/" target="blank">
                                <h4 class="mt-2"><img id="line-img" src="../../../design/assets/line.png" alt=""> Line
                                </h4>
                            </a>
                        </div>
                        ...
                        <div class="col-md-5 text-center " id="fb">
                            <a href="https://www.facebook.com/" target="blank">
                                <h4 class="m-3"><img id="fb-img" src="../../../design/assets/facebook-logo.png"
                                        alt="">Facebook</h4>
                            </a>
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-md-5 text-center p-2" id="mail">
                            <a href="mailto:someone@example.com" target="blank">
                                <h4 class="mt-2"><img id="mail-img" src="../../../design/assets/close-envelope.png"
                                        alt=""> Mail</h4>
                            </a>
                        </div>
                        <div class="col-md-2"></div>
                        <div class="col-md-5 text-center " id="call">
                            <a href="tel:+66123456789" target="blank">
                                <h4 class="m-3"><img id="call-img" src="../../../design/assets/phone-receiver.png"
                                        alt="">Call</h4>
                            </a>
                        </div>
                    </div>
